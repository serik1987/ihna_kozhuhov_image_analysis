...
class Traces:
    ...
    def clean(self):
        """
        Cleans the traces and then cleans the object. After trace cleaning will be completed,
        the operating memory will be facilitated some vector parameters will be inavailable
        """
        del self.__times
        self.__times = None
        del self.__traces
        self.__traces = None
        del self.__frequencies
        self.__frequencies = None
        del self.__spectrums
        self.__spectrums = None
        del self.__avg_trace
        self.__avg_trace = None
        del self.__reference
        self.__reference = None
        del self.__reference_psd
        self.__reference_psd = None
